...
export const NOTIFICATION_TEMPLATES: NotificationTemplateConfig[] = [
  ...
  {
    code: "shooting_pickup_reminder_digital",
    step: 1,
    stepName: "Shooting",
    title: "Has the shooting been completed?",
    description: "Confirm that the shooting has ended so the photographer can upload their selection.",
    emailSubject: "📋 Shooting reminder - {collectionName} by {clientName} - {photographerName}",
    ctaText: "Confirm shooting ended",
    ctaUrlTemplate: "/collections/{collectionId}?step=shooting",
    triggerType: "before",
    triggerEvent: "shooting_end",
    triggerOffsetMinutes: -30,
    triggerCondition: "is_digital",
    emailRecipients: ["producer"],
    inappRecipients: [],
  },
  {
    code: "shooting_completed_confirmed_to_photographer",
    step: 4,
    stepName: "Photographer selection",
    title: "Shooting has ended – share your selection",
    description: "The shooting has been confirmed as complete. Share your photo selection with the client.",
    emailSubject: "📸 Share your selection - {collectionName} by {clientName}",
    ctaText: "Upload selection",
    ctaUrlTemplate: "/collections/{collectionId}?step=photographer_selection",
    triggerType: "on",
    triggerEvent: "shooting_completed_confirmed",
  ...
  {
    code: "photographer_last_check_shared_additional_materials",
    step: 10,
    stepName: "Photographer last check",
    title: "{photographerName} has shared an additional link",
    description: "{commentorName} uploaded a new link. Review the additional photos before confirming the collection.",
    emailSubject: "🆕 Photographer has shared additional photos - {collectionName} by {clientName} - {photographerName}",
    ctaText: "Review new link",
    ctaUrlTemplate: "/collections/{collectionId}?step=client_confirmation",
    triggerType: "on",
    triggerEvent: "photographer_last_check_shared_additional_materials",
    triggerOffsetMinutes: 0,
    triggerCondition: null,
    emailRecipients: ["client"],
    inappRecipients: ["client"],
