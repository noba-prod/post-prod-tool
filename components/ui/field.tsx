...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "text-sm font-medium leading-none has-data-checked:bg-primary/5 has-data-checked:border-primary dark:has-data-checked:bg-primary/10 gap-2 group-data-[disabled=true]/field:opacity-50 peer-disabled:text-muted-foreground has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border [&>*]:data-[slot=field]:p-3 group/field-label peer/field-label flex w-fit",
